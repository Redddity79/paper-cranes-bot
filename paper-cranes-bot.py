...
async def start(message: types.Message, state: FSMContext):
	print(message)
	with open("users-info.txt") as file:
	...
	with open("users-info.txt", 'w') as file:
...
async def choose_crane(message:types.Message, state: FSMContext):
	...
	with open('cranes.txt') as file:
		cranes = json.load(file)
	file.close()
...
async def crane_text(message: types.Message, state: FSMContext):
	...
	with open('cranes.txt', 'w') as file:
		file.write(json.dumps(cranes))
	file.close()
